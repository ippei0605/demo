...
## 使い方
1. 2016-11-12 にサンプルデータを登録しています。花咲カントリークラブ (山梨県) 1H～18H です。まずは、Hole を変更しつつ、Score、Layout、Total タブの表示内容を確認してください。
...
#### 結果  
    {"rows":[
    {"key":["2016-11-12",1],"value":{"count":4,"putt":2}},
    {"key":["2016-11-12",2],"value":{"count":4,"putt":2}},
    {"key":["2016-11-12",3],"value":{"count":5,"putt":1}},
    ... (省略) ...,
    ]}
